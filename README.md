...
See `vitis-workflow/docs/init-workflow.md`, `vitis-workflow/docs/sim-workflow.md`, `vitis-workflow/docs/synth-workflow.md`, and `vitis-workflow/docs/cosim-workflow.md` for details.
